...
The Docugami Python library provides convenient access to the Docugami REST API from any Python 3.8+
...
You can enable logging by setting the environment variable `DOCUGAMI_LOG` to `info`.

```shell
$ export DOCUGAMI_LOG=info
```
